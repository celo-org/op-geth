...
# Every block contains a system tx that pays nothing for gas so we must subtract this from the total gas per block
...
expected_balance_change=$((base_fee * (gas_used-system_tx_gas)))
