...
func TestListFeeCost(t *testing.T) {
	...
	assert.Equal(t, int64(10000), list.TotalCostFor(&curr1).Int64())

	toBeRemoved := txC(8, 2, 1, 15000, &curr2)
	list.Add(toBeRemoved, DefaultConfig.PriceBump, nil, rates)
	assert.Equal(t, int64(30000), list.TotalCostFor(&curr2).Int64())
	assert.Equal(t, int64(10000), list.TotalCostFor(&curr1).Int64())

	list.Add(txC(9, 3, 2, 5000, &curr3), DefaultConfig.PriceBump, nil, rates)
	assert.Equal(t, int64(15000), list.TotalCostFor(&curr3).Int64())
	assert.Equal(t, int64(30000), list.TotalCostFor(&curr2).Int64())
	assert.Equal(t, int64(10000), list.TotalCostFor(&curr1).Int64())
	...
	assert.Equal(t, int64(15000), list.TotalCostFor(&curr3).Int64())
	assert.Equal(t, int64(30000), list.TotalCostFor(&curr2).Int64())
	assert.Equal(t, int64(20000), list.TotalCostFor(&curr1).Int64())
	...
	assert.Equal(t, int64(15000), list.TotalCostFor(&curr3).Int64())
	assert.Equal(t, int64(0), list.TotalCostFor(&curr2).Int64())
	assert.Equal(t, int64(20000), list.TotalCostFor(&curr1).Int64())
}
...
func TestFilterWhitelistedStrict(t *testing.T) {
	...
	assert.Equal(t, int64(0), list.TotalCostFor(&curr2).Int64())
	assert.Equal(t, int64(0), list.TotalCostFor(&curr3).Int64())
	assert.Equal(t, int64(10000), list.TotalCostFor(&curr1).Int64())
}
...
func TestFilterBalance(t *testing.T) {
	...
	removed, invalids := list.Filter(map[common.Address]*big.Int{
		curr1: big.NewInt(10000),
		curr2: big.NewInt(9999),
		curr3: big.NewInt(10000),
	}, 15000)
	assert.Len(t, removed, 1)
	assert.Len(t, invalids, 0)
	assert.Equal(t, removed[0], toBeRemoved)
...
func TestFilterBalanceStrict(t *testing.T) {
	...
	removed, invalids := list.Filter(map[common.Address]*big.Int{
		curr1: big.NewInt(10001),
		curr2: big.NewInt(9999),
		curr3: big.NewInt(10001),
	}, 15000)
	assert.Len(t, removed, 1)
	assert.Len(t, invalids, 1)
	assert.Equal(t, removed[0], toBeRemoved)
...
func TestFilterBalanceGasLimit(t *testing.T) {
	...
	removed, invalids := list.Filter(map[common.Address]*big.Int{
		curr1: big.NewInt(20000),
		curr2: big.NewInt(20000),
		curr3: big.NewInt(20000),
	}, 10000)
	assert.Len(t, removed, 1)
	assert.Len(t, invalids, 0)
	assert.Equal(t, removed[0], toBeRemoved)
