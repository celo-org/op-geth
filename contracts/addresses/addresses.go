...
type CeloAddresses struct {
	CeloTokenAddress            common.Address
	FeeHandlerAddress           common.Address
	FeeCurrencyDirectoryAddress common.Address
}
...
var (
	...
	AlfajoresAddresses = &CeloAddresses{
		CeloTokenAddress:            common.HexToAddress("0xF194afDf50B03e69Bd7D057c1Aa9e10c9954E4C9"),
		FeeHandlerAddress:           common.HexToAddress("0xEAaFf71AB67B5d0eF34ba62Ea06Ac3d3E2dAAA38"),
		FeeCurrencyDirectoryAddress: common.HexToAddress("0x9212Fb72ae65367A7c887eC4Ad9bE310BAC611BF"),
	}

	BaklavaAddresses = &CeloAddresses{
		CeloTokenAddress:            common.HexToAddress("0xdDc9bE57f553fe75752D61606B94CBD7e0264eF8"),
		FeeHandlerAddress:           common.HexToAddress("0xeed0A69c51079114C280f7b936C79e24bD94013e"),
		FeeCurrencyDirectoryAddress: common.HexToAddress("0xD59E1599F45e42Eb356202B2C714D6C7b734C034"),
	}
)
