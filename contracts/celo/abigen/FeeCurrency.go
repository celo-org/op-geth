...
func (_FeeCurrency *FeeCurrencyTransactor) CreditGasFees(opts *bind.TransactOpts, recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _FeeCurrency.contract.Transact(opts, "creditGasFees", recipients, amounts)
}

// CreditGasFees is a paid mutator transaction binding the contract method 0x2e0f98ad.
//
// Solidity: function creditGasFees(address[] recipients, uint256[] amounts) returns()
func (_FeeCurrency *FeeCurrencySession) CreditGasFees(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _FeeCurrency.Contract.CreditGasFees(&_FeeCurrency.TransactOpts, recipients, amounts)
}

// CreditGasFees is a paid mutator transaction binding the contract method 0x2e0f98ad.
//
// Solidity: function creditGasFees(address[] recipients, uint256[] amounts) returns()
func (_FeeCurrency *FeeCurrencyTransactorSession) CreditGasFees(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _FeeCurrency.Contract.CreditGasFees(&_FeeCurrency.TransactOpts, recipients, amounts)
}
...
func (_FeeCurrency *FeeCurrencyTransactor) CreditGasFees0(opts *bind.TransactOpts, from common.Address, feeRecipient common.Address, arg2 common.Address, communityFund common.Address, refund *big.Int, tipTxFee *big.Int, arg6 *big.Int, baseTxFee *big.Int) (*types.Transaction, error) {
	return _FeeCurrency.contract.Transact(opts, "creditGasFees0", from, feeRecipient, arg2, communityFund, refund, tipTxFee, arg6, baseTxFee)
}

// CreditGasFees0 is a paid mutator transaction binding the contract method 0x6a30b253.
//
// Solidity: function creditGasFees(address from, address feeRecipient, address , address communityFund, uint256 refund, uint256 tipTxFee, uint256 , uint256 baseTxFee) returns()
func (_FeeCurrency *FeeCurrencySession) CreditGasFees0(from common.Address, feeRecipient common.Address, arg2 common.Address, communityFund common.Address, refund *big.Int, tipTxFee *big.Int, arg6 *big.Int, baseTxFee *big.Int) (*types.Transaction, error) {
	return _FeeCurrency.Contract.CreditGasFees0(&_FeeCurrency.TransactOpts, from, feeRecipient, arg2, communityFund, refund, tipTxFee, arg6, baseTxFee)
}

// CreditGasFees0 is a paid mutator transaction binding the contract method 0x6a30b253.
//
// Solidity: function creditGasFees(address from, address feeRecipient, address , address communityFund, uint256 refund, uint256 tipTxFee, uint256 , uint256 baseTxFee) returns()
func (_FeeCurrency *FeeCurrencyTransactorSession) CreditGasFees0(from common.Address, feeRecipient common.Address, arg2 common.Address, communityFund common.Address, refund *big.Int, tipTxFee *big.Int, arg6 *big.Int, baseTxFee *big.Int) (*types.Transaction, error) {
	return _FeeCurrency.Contract.CreditGasFees0(&_FeeCurrency.TransactOpts, from, feeRecipient, arg2, communityFund, refund, tipTxFee, arg6, baseTxFee)
}
